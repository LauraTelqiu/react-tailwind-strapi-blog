    ...
    <div className='w-full h-[80px] z-10 bg-white fixed drop-shadow-lg relative'>
      <div className='flex justify-between items-center w-full h-full md:max-w-[1240px] m-auto'>
        ...
        <div className='hidden md:flex sm:mr-10 md:mr-10'>
          <button className="text-white border bg-indigo-600 border-indigo-600 hover:bg-transparent hover:text-indigo-600 rounded-md mr-4 px-8 py-3">
            Login
          </button>
          <button className="text-white border bg-indigo-600 border-indigo-600 hover:bg-transparent hover:text-indigo-600 rounded-md px-8 py-3">
            Sign Up
          </button>
